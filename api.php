...
if (!is_array($payload) || !in_array($payload['action'] ?? '', ['load','save','forms','login','users:list','users:save','users:delete','company:profile:get','company:profile:save','documents:list','documents:save','documents:get','documents:delete','clients:import-csv','clients:import-xlsx','clients:fields:get','clients:fields:save','calendar:list','calendar:save','calendar:delete'], true)) failRequest(400, 'Invalid database operation.');
