...
if (!is_array($payload) || !in_array($payload['action'] ?? '', ['load','save','forms','login','users:list','users:save','users:delete','company:profile:get','company:profile:save'], true)) failRequest(400, 'Invalid database operation.');
